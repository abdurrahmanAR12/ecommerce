                    ...
                    <div className="px-3 py-3 lg:px-5 lg:pl-3">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center justify-start">
                                ...
                                <Link href="/admins/dash" className="flex ml-2 md:mr-24">
                                    ...
                                    <><span role='button' className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Millionairo</span>
                                        ...
                                        <span style={{ fontSize: ".7em", alignItems: " center" }}
                                            className="flex justify-center bg-gray-600 text-white rounded-md w-10 sm text-base h-4">Admins</span>
                                    </>
                                </Link>
                            </div>
                                ...
                                <div className="flex items-center ml-3">
                                    ...
                                    <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600">
                                        ...
                                        <ul className="py-1" role="none">
                                            <li>
                                                <Link href="/admin/dashboard" role="menuitem">
                        ...
                        <ul className="space-y-2 font-medium">
                            <li>
                                <Link href="/admin/dash">
                                    <span role='button' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <Link href="/admin/seo">
                                    <span role='button' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                            className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white bi bi-search"
                                            viewBox="0 0 16 16">
                                            <path
                                                d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                        </svg>
                                        <span className="flex-1 ml-3 whitespace-nowrap">Seo</span>
                                    </span>
                                </Link>
                            </li>
                            <li>
                                <Link href="/admin/sliders">
                                    <span role='button' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        ...
                                        <span className="flex-1 ml-3 whitespace-nowrap">Sliders</span>
                                    </span>
                                </Link>
                            </li>
                            {/* <li>
                                ...
                                >
                                    <span role='button' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        ...
                                        <span className="flex-1 ml-3 whitespace-nowrap">Create Another Admin</span>
                                    </span>
                                </Link>
                            </li> */}
                        </ul>
